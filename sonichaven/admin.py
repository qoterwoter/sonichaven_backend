...
class CustomUserAdmin(UserAdmin):
    list_display = ('username', 'first_name', 'last_name', 'is_staff', 'is_soundengineer', 'is_artist', 'pk')
    list_filter = ('is_staff', 'is_superuser', 'is_active', 'groups', 'is_soundengineer', 'is_artist')
    fieldsets = (
        (None, {'fields': ('username', 'password')}),
        ('Персональная инфомрация',
         {'fields': ('first_name', 'last_name', 'email', 'phone_number', 'profile_image', 'image_tag')}),
