    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_soundengineer', models.BooleanField(default=False, verbose_name='Статус звукорежиссера')),
                ('is_artist', models.BooleanField(default=False, verbose_name='Статус артиста')),
